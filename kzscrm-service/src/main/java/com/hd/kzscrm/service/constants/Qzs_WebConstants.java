...
public class Qzs_WebConstants {

    /**
     * 私有化构造函数
     */
    private Qzs_WebConstants(){
     ...
     * 手机验证码失效时间
     */
    public static int MOBILE_CHK_CODE_EXPIRE_TIME = 300;
     ...
     * 系统主key
     */
    public static String SYS_KEY_MAIN = "jai-web";
     ...
     * 企业星级规则表
     */
    public static String JAI_LEVEL_RULE = "qzs_level_rule";


    /**
     * 企业比率规则表
     */
    public static String JAI_LEVEL_PROPORTION = "qzs_level_proportion";
   ...
   // add by linxiaojun
     ...
     * 金融机构
     */
    public static final String JAI_FINANCIAL_ORG = "qzs_financial_org";

    /**
     * 文章
     */
    public static final String JAI_CMS_ARTICLE = "qzs_cms_article";
     ...
     * 网站名称
     */
    public static String WEB_TITILE_CN_ZH = "聚智能";
