package com.hd.kzscrm.service.param.area;

import com.hd.kzscrm.common.param.PageParam;

public class BaseAreaParam extends PageParam {
	    ...
	    private   Long   id ;
	        ...
	        */
			...
			/**
			 * @return the areaCodeLike
			 */
			public Long getAreaCodeLike() {
				return areaCodeLike;
			}

			/**
			 * @param areaCodeLike the areaCodeLike to set
			 */
			public void setAreaCodeLike(Long areaCodeLike) {
