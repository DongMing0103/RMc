...
public class IDCard {
     ...
     * 根据身份证号码第17位判断男女
     * @author 黄霄仪
     * @date 2017年3月16日 上午9:48:13
     */
    public static String sex(String idCard){
    	Integer sexFlag=Integer.valueOf(idCard.substring(16, 17));
    	if(sexFlag%2==1){
    		return "男";
    	}else{
    		return "女";
    ...
    public static void main(String[] args) {
        ...
        String IDCardNum = "36012********7";
        String sex = sex("360122***7");
