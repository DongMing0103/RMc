...
public enum IndustryStatusEnum {
    ...
    IndustryStatusEnum(String code, String name) {
        this.code = code;
        this.name = name;
    }

    
    public static List<IndustryStatusEnum> getStarLevelEnumList(){
        List<IndustryStatusEnum> list = Arrays.asList(IndustryStatusEnum.values());
        Collections.sort(list,new Comparator<IndustryStatusEnum>(){
            public int compare(IndustryStatusEnum obj1, IndustryStatusEnum obj2) {
                //比较每个ArrayList的第二个元素
    ...
    public static String getName(String code) {
        for (IndustryStatusEnum orderStatusEnum : IndustryStatusEnum.values()) {
