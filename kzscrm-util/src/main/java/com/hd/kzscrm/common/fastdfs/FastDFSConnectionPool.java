...
* @date 2017年3月8日 上午10:34:09 
*
 */
public class FastDFSConnectionPool {

	private static final Log logger = LogFactory.getLog(FastDFSConnectionPool.class);

	private String configFile = FastDFSConnectionPool.class.getClassLoader().getResource("config/fastdfsConfig.conf").getPath();
